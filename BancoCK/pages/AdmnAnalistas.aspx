<%@ Page Title="" Language="C#" MasterPageFile="~/Configuraciones.Master" AutoEventWireup="true" CodeBehind="AdmnAnalistas.aspx.cs" Inherits="BancoCK.pages.AdmnAnalistas" %>
    ...
    <asp:Panel ID="PanelInsertar" runat="server">
        <div class="ContenedorInsertar">
            ...
            <div class="form__group field">
                <input type="Text" value="Analista" id="tbxRol" class="form__field browser-default " runat="server" readonly="Readonly" />
