...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="contenedor_tabla">
            <asp:GridView class="centered responsive-table tabla" OnPageIndexChanging="GridView1_PageIndexChanging" ID="GridView1" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False">
                <Columns>
    ...
    <div id="aviso" class="modal">
     ...
     <div id="confirmacion" class="modal">
                ...
                <div class="modal-content center">
                    ...
                    <br>
                    <asp:Button runat="server" class="btn" Text="Aceptar" />
